...
if __name__=="__main__":
   ...
   arseni = Player(nickname = 'Arseni', email = 'arsenidudko@mail.ru', password = '123456', wallet=wallet)
   ...
   arseni2 = Player(nickname = 'Arseni2', email = 'arsenidudko2@mail.ru', password = '765432', wallet=wallet)
...
########################################################################################################################
   ...
   Alex  = Admin(nickname='Alex', email='admin_alex@mail.ru', password='1234567', wallet=admin_wallet)
   Alex2 = Moderator(nickname='Alex2', email='moderator_alex@mail.ru', password='12345dsa67', wallet=admin_wallet)
